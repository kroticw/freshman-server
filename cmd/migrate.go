...
func init() {
	...
	migrateCmd.Flags().BoolVar(&migrateCmdUp,
		"up", true, "Накатить миграции. Это действие по умолчанию")
	migrateCmd.Flags().IntVar(&migrateCmdDown,
		"down", 0, "Откат миграций. Значение - количество миграций для отката")
}
